...
int main(int argc, char *argv[]){
	...
	inic_vector_F(F, SIZE, dF); // frequency for one round trip [THz]
	...
	// Save input fields files
	bool save_input_fields = true;
	...
	////////////////////////////////////////////////////////////////////////////////////////
	// Evolution in the crystal and repetition of round trips
